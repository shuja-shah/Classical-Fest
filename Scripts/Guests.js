const artist = [
    { name: 'Abida Parveen', id: '0', description :'Abida Parveen is a sufi singer from Sindh, She Specalizes in the art of'
+ ' Sufism and she devotes her life to the spirituality of the world.' , img : 'Assets/AbidaP.png'},
    { name: 'Deva Premal', id: '1', description :'Deva Premal is a singer known for introducing Sanskrit mantras into the mainstream'
    + 'Her meditative, spiritual music produced with Prabhu Music puts ancient Tibetan and Sanskrit mantras into contemporary settings.', img : 'Assets/Dava.jfif'},
    { name :'Roger Waters', id: '2', description :'George Roger Waters is an English musician, singer songwriter and composer'
